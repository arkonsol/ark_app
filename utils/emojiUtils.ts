...
export const isEmojiOnly = (text: string): boolean => {
    ...
    const emojiRegex = new RegExp(`^${emojiRanges}$`);
    return emojiRegex.test(text);
  };
  
  // Optional: Add helper functions for emoji-related operations
  export const containsEmoji = (text: string): boolean => {
    ...
    const regex = new RegExp(emojiRanges);
  ...
  export const countEmojis = (text: string): number => {
    ...
    const regex = new RegExp(emojiRanges, 'g');
